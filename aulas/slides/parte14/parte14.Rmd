...
<div, class="column-right">
```{r, fig.width=4, fig.height=3.5}
g1 + geom_point(aes(colour=Terapia, group=Terapia), show.legend = FALSE, size=2) +
...
rownames(anovafit) <- c("Terapia (Entre)", "Erro (Dentro)", "Total")
colnames(anovafit) <- c("GL", "SQ", "QM", "F", "p-valor")

kable(anovafit, digits = c(0, 2, 2, 2, 5), caption="Tabela ANOVA para comparação entre Terapias")
```

Pela tabela ANOVA (F=3.85 e p-valor=0.028) temos evidência que os três grupos de terapia diferem significativamente em relação ao ganho de peso.

Mas quais grupos diferem entre si?
